...
EXPRESSION_PATH = Path("data/processed/geo_gse44076_messy_analysis_ready/expression_matrix.tsv")
METADATA_PATH = Path("data/processed/geo_gse44076_messy_analysis_ready/metadata.tsv")

OUTPUT_DIR = Path("outputs/validation/geo_gse44076_messy_analysis_ready")
